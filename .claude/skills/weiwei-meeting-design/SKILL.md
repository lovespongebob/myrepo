...
description: >-
  ...
  plan; asks how many people to invite or how much time to book; asks how to
  handle conflict, tangents, or a dominating stakeholder in a meeting; or asks
  whether something should be a meeting at all. Trigger even if the word
  "meeting" never appears — "help me plan our project kickoff," "our standups
  feel useless," "I need to run a retro," and "how do I get sign-off on this
  design from execs" are all in scope.
---
...
5. **Stage of work** — beginning (starting something), middle (in-flight work),
   or end (closing/reflecting). This selects the template family.
